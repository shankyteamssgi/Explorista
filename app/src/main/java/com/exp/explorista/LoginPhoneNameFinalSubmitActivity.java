...
public class LoginPhoneNameFinalSubmitActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_login_phone_name_final_submit);
        imageView = findViewById(R.id.image_back_login_phone_name_final_submit);
...
//                editor.apply();
        ...
        rl_phone_name_final = findViewById(R.id.rl_one_login_phone_name_final_submit);
        llShimmer = findViewById(R.id.ll_shimmer_customer_login_phone_name_final_submit);
        shimmerFrameLayout = findViewById(R.id.shimmerFrameLayout_customer_login_phone_name_final_submit);
        et_reg_name = findViewById(R.id.txt_name_login_phone_name_final_submit);
        tv_reg_phone = findViewById(R.id.tv_phone_customer_login_phone_name_final_submit);
        btnPhoneNameFinal = findViewById(R.id.btnLoginPhoneNameFinalSubmit);
    ...
    private void phone_name_final_submit() {
                ...
                Objects.requireNonNull(connectivityManager.getNetworkInfo(ConnectivityManager.TYPE_WIFI)).getState() == NetworkInfo.State.CONNECTED || (Objects.requireNonNull(connectivityManager.getNetworkInfo(ConnectivityManager.TYPE_MOBILE)).getState() == NetworkInfo.State.CONNECTED  && Objects.requireNonNull(connectivityManager.getNetworkInfo(ConnectivityManager.TYPE_WIFI)).getState() == NetworkInfo.State.CONNECTED) )
        {
            ...
            Call<LoginPhoneNameFinalSubmitResponse> call = api.getLoginPhoneNameFinalSubmit(cust_name,cust_phone);
            call.enqueue(new Callback<LoginPhoneNameFinalSubmitResponse>() {
                @Override
                public void onResponse(Call<LoginPhoneNameFinalSubmitResponse> call, Response<LoginPhoneNameFinalSubmitResponse> response) {

                   if (response.body().getMessageResponse().equals("customer data inserted"))
                    {

                        Toast.makeText(LoginPhoneNameFinalSubmitActivity.this, "Data Success", Toast.LENGTH_SHORT).show();
                        SharedPreferences sharedPreferences = getSharedPreferences(SharedConfig.mypreference,MODE_PRIVATE);
                        SharedPreferences.Editor editor = sharedPreferences.edit();
                        editor.putString("key_phone_one_name_submit",cust_phone);
                        editor.apply();
                    //    try {
                      //      if ((sharedPreferences.getString("key_phone_one", null) != null)) {
                                ...
                                Intent intent = new Intent(LoginPhoneNameFinalSubmitActivity.this, LoginLocationActivity.class);
                    ...
                    else if(response.body().getMessageResponse().equals("customer data not inserted"))
                    {
                        ...
                        Toast.makeText(LoginPhoneNameFinalSubmitActivity.this, "Data not success", Toast.LENGTH_SHORT).show();
                        SharedPreferences sharedPreferences = getSharedPreferences(SharedConfig.mypreference,MODE_PRIVATE);
                        SharedPreferences.Editor editor = sharedPreferences.edit();
                        editor.clear();
                        editor.apply();
                        Intent intent = new Intent(LoginPhoneNameFinalSubmitActivity.this,LoginOrSignUpActivity.class);
                    ...
                    else if(response.body().getMessageResponse().equals("invalid method"))
                    {
                        ...
                        Toast.makeText(LoginPhoneNameFinalSubmitActivity.this, "Invalid Method", Toast.LENGTH_SHORT).show();
                        SharedPreferences sharedPreferences = getSharedPreferences(SharedConfig.mypreference,MODE_PRIVATE);
                        SharedPreferences.Editor editor = sharedPreferences.edit();
                        editor.clear();
                        editor.apply();
                ...
                @Override
                public void onFailure(Call<LoginPhoneNameFinalSubmitResponse> call, Throwable t) {
                    shimmerFrameLayout.stopShimmer();
                    llShimmer.setVisibility(View.GONE);
                    rl_phone_name_final.setVisibility(View.GONE);
    ...
    protected void onStart() {
        ...
        try
        {
            if((sharedPreferences.getString("key_phone_one_name_submit", null) != null ))
            {
