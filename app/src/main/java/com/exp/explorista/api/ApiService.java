...
public interface ApiService {
    ...
    @FormUrlEncoded
    @POST("check_otp_expiration.php")
    Call<CheckOTPExpirationResponse> getCheckOTPExpiration
    ...
    Call<LoginGoogleSubmitResponse> getLoginGoogleSubmit
            (@Field("cust_phone") String cust_phone,@Field("cust_email") String cust_email);
