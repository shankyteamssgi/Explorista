...
public class LoginOrSignupSkipLocationActivity extends AppCompatActivity {
        ...
        appCompatButton.setOnClickListener(new View.OnClickListener() {
            ...
            //    editor_one.putString("key_phone_two_login_location",cust_phone_two);
               ...
               // editor_one.apply();
                ...
                try
                {
                    if((sharedPreferences_two.getString("key_uuid_final", null) != null ))
                    {

                        //  Intent intent1 = new Intent(LoginOrSignUpActivity.this,LoginPhoneOTPVerificationNotExistUserActivity.class);
                        Intent intent = new Intent(LoginOrSignupSkipLocationActivity.this, DashboardActivity.class);
    ...
    protected void onStart() {
        ...
        try
        {
           if((sharedPreferences.getString("key_uuid_final", null) != null ))
            {
    ...
    public void onBackPressed() {
        ...
        if(sharedPreferences_two.getString("key_uuid", null) != null ) {
            super.onBackPressed();
            Intent intent = new Intent(LoginOrSignupSkipLocationActivity.this, LoginOrSignUpActivity.class);
